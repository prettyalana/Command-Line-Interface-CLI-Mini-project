class Game
    attr_accessor :name, :answer, :again, :yes, :no, :over
    ...
    def play
      ...
      puts "Before we get started, shall I explain to you the rules of the game?"
      @player_answer = answer_yes_no

      if @yes.include?(@player_answer)
        puts rules
        puts "Let's get started!"
      else @no.include?(@player_answer)
    ...
    def level_three
      ...
      puts "The random words are #{random_words[0..4]} and the random numbers are from 1-10"
